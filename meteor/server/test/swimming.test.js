...
const ct = CONTEST_TYPES[1].object;
...
describe('swimming', function () {
    it('updates a measurement', function () {
        ...
        p.age = 16;
        p.addMeasurements(log, 'st_face_up_100', [7.33], groupAccount, stationAccount);
    ...
    it('validates the configuration of Hans Müller without stationAccount', function () {
        ...
        const p = new Athlete(log, 'Hans', 'Müller', 2000, true, 'Q#z', '0', ct.maxAge, ct);
        p.age = 16;
        p.addMeasurements(log, 'st_face_up_100', [700], groupAccount, stationAccount);
        p.addMeasurements(log, 'st_diving', [13, 13], groupAccount, stationAccount);
        p.addMeasurements(log, 'st_crawl_100', [80], groupAccount, stationAccount);
        p.addMeasurements(log, 'st_butterfly_50', [70], groupAccount, stationAccount);
    ...
    it('calculates the configuration of Hans Müller without stationAccount', function () {
        ...
        ct.calculate(log, p, [groupAccount], false).score.should.be.equal(26);
    });
    ...
    it('calculates the configuration of Hans Müller with stationAccount', function () {
        ...
        ct.calculate(log, p, [groupAccount, stationAccount], false).score.should.be.equal(26);
    });
    ...
    it('calculates the configuration of Hans Müller with stationAccount and signature required', function () {
        ...
        ct.calculate(log, p, [groupAccount, stationAccount], true).score.should.be.equal(26);
    });
